...
Page({
  ...
  onLoad: function (e) {    
    ...
    var that = this;
    wx.request({
      url: app.globalData.mainDomain+ app.globalData.subDomain +'/shop/goods/detail',
      data: {
        id: e.id
      },
  ...
  getVideoSrc: function (videoId) {
    var that = this;
    wx.request({
      url: app.globalData.mainDomain + app.globalData.subDomain + '/media/video/detail',
      data: {
        videoId: videoId
      },
      success: function (res) {
  ...
  getKanjiaInfo: function (kjid, joiner) {
    var that = this;
    wx.request({
      url: app.globalData.mainDomain + app.globalData.subDomain + '/shop/goods/kanjia/info',
      data: {
        kjid: kjid,
        joiner: joiner,
      },
  ...
  getKanjiaInfoMyHelp: function (kjid, joiner) {
    var that = this;
    wx.request({
      url: app.globalData.mainDomain + app.globalData.subDomain + '/shop/goods/kanjia/myHelp',
      data: {
        kjid: kjid,
        joinerUser: joiner,
  ...
  helpKanjia: function () {
    var that = this;
    wx.request({
      url: app.globalData.mainDomain + app.globalData.subDomain + '/shop/goods/kanjia/help',
      data: {
        kjid: that.data.kjId,
