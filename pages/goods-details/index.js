...
Page({
  ...
  labelItemTap: function(e) {
    ...
    */
    ...
    if (canSubmit) {
      wx.request({
        url: app.globalData.mainDomain+ app.globalData.subDomain +'/shop/goods/price',
        data: {
  ...
  */
  ...
  reputation: function (goodsId) {
    var that = this;
    wx.request({
      url: app.globalData.mainDomain + app.globalData.subDomain + '/shop/goods/reputation',
      data: {
        goodsId: goodsId
      },
      success: function (res) {
  ...
  goKanjia: function () {
    ...
    wx.request({
      url: app.globalData.mainDomain + app.globalData.subDomain + '/shop/goods/kanjia/join',
      data: {
